...
The **Your boards** list can be arranged by dragging a board, pressing Alt+Up/Down while its sidebar entry is focused, or pressing **A–Z** to sort by name. The chosen order also appears in the workspace menu and home overview. This is a preference saved in the current browser; other people can arrange their own lists independently.
